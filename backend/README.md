...
```
cd existing_repo
git remote add origin https://gitlab.com/officerebels/recipe-meal-planner-backend.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/officerebels/recipe-meal-planner-backend/-/settings/integrations)
